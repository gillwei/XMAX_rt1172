...
typedef uint8 IOP_AUTO_BURN_IN_TYPE; enum
    {
    IOP_AUTO_BURN_IN_OPERATION,
    IOP_AUTO_BURN_IN_SET_TARTGET_TIME,
    IOP_AUTO_BURN_IN_GET_ELAPSED_TIME,

    IOP_AUTO_BURN_IN_INVALID,
    IOP_AUTO_BURN_IN_CNT = IOP_AUTO_BURN_IN_INVALID,
    };

typedef uint8 IOP_AUTO_BURN_IN_OPERATION_TYPE; enum
    {
    IOP_AUTO_BURN_IN_OPERATION_RESET_ALL,
    IOP_AUTO_BURN_IN_OPERATION_SET_START_FLAG,
    IOP_AUTO_BURN_IN_OPERATION_GET_RESULT,

    IOP_AUTO_BURN_IN_OPERATION_INVALID,
    IOP_AUTO_BURN_IN_OPERATION_CNT = IOP_AUTO_BURN_IN_OPERATION_INVALID,
    };
