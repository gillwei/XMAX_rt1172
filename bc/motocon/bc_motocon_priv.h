...
bc_motocon_parse_result_t bc_motocon_parser_authenticationv2( const uint8_t* bytes, const uint32_t length );
...
bc_motocon_parse_result_t bc_motocon_parser_ccuid_request( void );
...
bc_motocon_parse_result_t bc_motocon_parser_ignition_state_request( void );
