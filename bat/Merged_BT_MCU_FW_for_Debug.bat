...
if "%BT_ADDRESS%" NEQ "" (
    if "%BT_VERSION%" NEQ "" (
        srec_cat.exe ..\submodule\rt1172_bootloader\Debug\IXWW22_BLD.srec -M ..\Debug\LinkCard-RT1172.srec -M -GEN %BT_ADDRESS% %BT_VERSION_END% -CONSTant_Big_Endian %BT_VERSION% 2 ..\submodule\cyw89820\Release_FW\BT_mdflash.bin -Binary -offset %BT_FIRMWARE_ADDRESS% SYS_A_VALIDITY.srec -M -O boot_image.srec -M -header=boot_image
