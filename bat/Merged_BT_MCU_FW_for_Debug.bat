...
if "%MCU_DATA_FOLDER%" NEQ "" (
    "%IDE%" -nosplash --launcher.suppressErrors -application org.eclipse.cdt.managedbuilder.core.headlessbuild -printErrorMarkers -import "%CURRENT_PATH%/submodule/rt1172_bootloader" -cleanBuild IXWW22_BLD/Debug -data "%MCU_DATA_FOLDER%"
    ...
    "%IDE%" -nosplash --launcher.suppressErrors -application org.eclipse.cdt.managedbuilder.core.headlessbuild -printErrorMarkers -import "%CURRENT_PATH%/submodule/rt1172_bootloader" -cleanBuild IXWW22_BLD/Debug
...
arm-none-eabi-objcopy -v -O srec %CURRENT_PATH%\Debug\LinkCard-RT1172.axf %CURRENT_PATH%\Debug\LinkCard-RT1172.srec
arm-none-eabi-objcopy -v -O srec %CURRENT_PATH%\submodule\rt1172_bootloader\Debug\IXWW22_BLD.axf %CURRENT_PATH%\submodule\rt1172_bootloader\Debug\IXWW22_BLD.srec
...
if "%BT_ADDRESS%" NEQ "" (
    if "%BT_VERSION%" NEQ "" (
        ...
        srec_cat.exe ..\Debug\LinkCard-RT1172.srec -M -GEN %BT_ADDRESS% %BT_VERSION_END% -CONSTant_Big_Endian %BT_VERSION% 2 ..\submodule\cyw89820\Release_FW\BT_mdflash.bin -Binary -offset %BT_FIRMWARE_ADDRESS% -O ..\Debug\LinkCard-RT1172_BT.srec -M -header=LinkCard-RT1172_BT -line_length=46 -disable=data-count
        srec_cat.exe ..\Debug\LinkCard-RT1172_BT.srec -fill 0x00 0x30202000 %BT_FIRMWARE_ADDRESS% -O ..\Debug\LinkCard-RT1172_BT.srec -M -header=LinkCard-RT1172_BT -line_length=46 -disable=data-count
        python3 IXWW22_OTA_FILE_GEN.py ..\Debug\LinkCard-RT1172_BT.srec ..\Debug\BKA_UPDATE_FILE.bin

        REM Merge Bootloader+APP+BT firmware+VALIDITY for development ECU that no signature and encryption are used
        srec_cat.exe ..\submodule\rt1172_bootloader\Debug\IXWW22_BLD.srec -M ..\Debug\LinkCard-RT1172.srec -M -GEN %BT_ADDRESS% %BT_VERSION_END% -CONSTant_Big_Endian %BT_VERSION% 2 ..\submodule\cyw89820\Release_FW\BT_mdflash.bin -Binary -offset %BT_FIRMWARE_ADDRESS% SYS_A_VALIDITY.srec -M -O boot_image.srec -M -header=boot_image -line_length=46 -disable=data-count
