...
const uint8_t dcd_data[] = {
	...
	/* #1.129, command: write_value, address: SEMC_BMCR0, value: 0x30524, size: 4 */
	0x40, 0x0D, 0x40, 0x08, 0x00, 0x03, 0x05, 0x24,
	/* #1.130, command: write_value, address: SEMC_BMCR1, value: 0x6030524, size: 4 */
	...
	/* #1.132, command: write_value, address: SEMC_BR1, value: 0x82000019, size: 4 */
	0x40, 0x0D, 0x40, 0x14, 0x82, 0x00, 0x00, 0x19,
	/* #1.133, command: write_value, address: SEMC_BR2, value: 0x84000019, size: 4 */
	0x40, 0x0D, 0x40, 0x18, 0x84, 0x00, 0x00, 0x19,
	/* #1.134, command: write_value, address: SEMC_BR3, value: 0x86000019, size: 4 */
	0x40, 0x0D, 0x40, 0x1C, 0x86, 0x00, 0x00, 0x19,
	/* #1.135, command: write_value, address: SEMC_SDRAMCR0, value: 0xF35, size: 4 */
	0x40, 0x0D, 0x40, 0x40, 0x00, 0x00, 0x0F, 0x35,
	/* #1.136, command: write_value, address: SEMC_SDRAMCR1, value: 0x652922, size: 4 */
	0x40, 0x0D, 0x40, 0x44, 0x00, 0x65, 0x29, 0x22,
	/* #1.137, command: write_value, address: SEMC_SDRAMCR2, value: 0x10920, size: 4 */
	0x40, 0x0D, 0x40, 0x48, 0x00, 0x01, 0x09, 0x20,
	/* #1.138, command: write_value, address: SEMC_SDRAMCR3, value: 0x50210A08, size: 4 */
	0x40, 0x0D, 0x40, 0x4C, 0x50, 0x21, 0x0A, 0x08,
	/* #1.139, command: write_value, address: SEMC_IPCR0, value: 0x80000000, size: 4 */
	0x40, 0x0D, 0x40, 0x90, 0x80, 0x00, 0x00, 0x00,
	/* #1.140, command: write_value, address: SEMC_IPCR1, value: 0x02, size: 4 */
	0x40, 0x0D, 0x40, 0x94, 0x00, 0x00, 0x00, 0x02,
	/* #1.141, command: write_value, address: SEMC_IPCR2, value: 0x00, size: 4 */
	0x40, 0x0D, 0x40, 0x98, 0x00, 0x00, 0x00, 0x00,
	/* #1.142, command: write_value, address: SEMC_IPCMD, value: 0xA55A000F, size: 4 */
	...
	0x40, 0x0D, 0x40, 0x3C, 0x00, 0x00, 0x00, 0x03,
	/* #25.2, command: write_value, address: SEMC_SDRAMCR3, value: 0x50210A09, size: 4 */
