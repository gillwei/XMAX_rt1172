...
enum task_priorities
    ...
    TASK_PRIO_BT_MNGR             = TASK_PRIO_VEHICLE_INFO_MNGR,
    TASK_PRIO_CM_MNGR             = TASK_PRIO_VEHICLE_INFO_MNGR,
    TASK_PRIO_JPEG                = TASK_PRIO_VEHICLE_INFO_MNGR,
    TASK_PRIO_I2C                 = TASK_PRIO_VEHICLE_INFO_MNGR,
