...
typedef enum tagIOP_VIM_CMD_PKT_ID_TYPE     //!< IOP VIM command packet sub ID definitions
    ...
    IOP_VIM_GET_WIFI_MAC                , /* 0x0102  */
    IOP_VIM_PKT_TW8836_RVC_SIGNAL_FORMAT_CMD                        , /* 0x0103  */
    IOP_VIM_PKT_TW8836_RVC_SIGNAL_FORMAT_DATA                       , /* 0x0104  */
    IOP_VIM_PKT_MIRACAST_DISABLE_MIRACAST_SERVICE                   , /* 0x0105  */
    IOP_VIM_PKT_MIRACAST_RECEIVE_SERIAL_DATA                        , /* 0x0106  */
    IOP_VIM_PKT_MIRACAST_SEND_ESN                                   , /* 0x0107  */
    IOP_VIM_PKT_MIRACAST_SEND_HDCP_INFORMATION                      , /* 0x0108  */
    IOP_VIM_PKT_MIRACAST_SEND_HID_EVENT                             , /* 0x0109  */
    IOP_VIM_PKT_MIRACAST_SEND_SCREEN_RESOLUTION                     , /* 0x010A  */
    IOP_VIM_PKT_MIRACAST_SEND_SERIAL_DATA                           , /* 0x010B  */
    IOP_VIM_PKT_MIRACAST_SEND_TOUCH_EVENT                           , /* 0x010C  */
    IOP_VIM_PKT_MIRACAST_SEND_UIBC_STATUS                           , /* 0x010D  */
    IOP_VIM_PKT_MIRACAST_SEND_WIFI_INFORMATION                      , /* 0x010E  */
    IOP_VIM_PKT_MIRACAST_SET_APP_ENTERED                            , /* 0x010F  */
    IOP_VIM_PKT_MIRACAST_SET_VISIBLE                                , /* 0x0110  */
    IOP_VIM_PKT_MIRACAST_SIGNAL_BT_SPP_CONNECTION_CHANGED           , /* 0x0111  */
    IOP_VIM_PKT_MIRACAST_SIGNAL_CONNECTION_STATUS_CHANGED           , /* 0x0112  */
    IOP_VIM_PKT_MIRACAST_SIGNAL_VISIBLE_CHANGED                     , /* 0x0113  */
    IOP_VIM_PKT_MIRACAST_TERMINATE_MIRACAST_SESSION                 , /* 0x0114  */
    IOP_VIM_ADVANCED_AUD_EFF_SET_CMD                                , /* 0x0115  */
    IOP_VIM_PKT_MIC_SET_CMD                                         , /* 0x0116  */
    IOP_VIM_PKT_MIC_SET_DATA                                        , /* 0x0117  */
    IOP_VIM_PKT_MIRACAST_EXTENSION_FUNCTION                         , /* 0x0118  */
    IOP_VIM_PKT_MAIN_PATH_MUTE_SET_CMD                              , /* 0x0119  */
    IOP_VIM_PKT_MIRACAST_SEND_DEVICE_NAME                           , /* 0x011A  */
    IOP_VIM_PKT_SCREEN_RGB_DATABASE                                 , /* 0x011B  */
    IOP_VIM_PKT_FM1388_CMD                                          , /* 0x011C  */
    IOP_VIM_PKT_FAN_CMD                                             , /* 0x011D  */
    IOP_VIM_DTV_AUX_SET_MUTE                                        , /* 0x011E  */
    IOP_VIM_DTV_AUX_SWITCH_CHANNEL                                  , /* 0x011F  */
    IOP_VIM_CHECK_EXT4_ERROR                                        , /* 0x0120  */
    IOP_VIM_GET_NAVIBOX_CONNECTION                                  , /* 0x0121  */
    IOP_VIM_STATIC_IMAGE_CMD                                        , /* 0x0122  */
    IOP_VIM_PKT_KEYPAD_BACK_LIGHT_COLOR_CMD                         , /* 0x0123  */
    IOP_VIM_NFC_CMD                                                 , /* 0x0124  */
    IOP_VIM_PKT_DAB_TUNER_CMD                                       , /* 0x0125  */
    IOP_VIM_PKT_DAB_TUNER_DATA                                      , /* 0x0126  */
    IOP_VIM_PKT_UART_CONSOLE_ENABLED                                , /* 0x0127  */
    IOP_VIM_PKT_DAY_NIGHT_MODE                                      , /* 0x0128  */
    IOP_VIM_PKT_MIX_INPUT_SELECTOR_CMD                              , /* 0x0129  */
    IOP_VIM_PKT_RSE_SWITCH_SCREEN_CMD                               , /* 0x012A  */
    IOP_VIM_PKT_CTP_CHECKSUM                                        , /* 0x012B  */
    IOP_VIM_DTV_WRITE_ENCRYPTION_KEY                                , /* 0x012C  */
    IOP_VIM_DTV_GET_ENCRYPTION_KEY                                  , /* 0x012D  */
    IOP_VIM_NB_RESET                                                , /* 0x012E  */
    IOP_VIM_PVM_OVERLAY_COLOER                                      , /* 0x012F  */
    IOP_VIM_HOPPER_TEST_MODE                                        , /* 0x0130  */
    IOP_VIM_PKT_SCREEN_RGB_CONTRAST_CMD                             , /* 0x0131  */
    IOP_VIM_PKT_SCREEN_RGB_CONTRAST_DATA                            , /* 0x0132  */
    IOP_VIM_ETHERNET_SUPPORT                                        , /* 0x0133  */
    IOP_VIM_ETHERNET_LINK_READY                                     , /* 0x0134  */
    IOP_VIM_ETHERNET_AUTO_NEGOTIATE_ENABLED                         , /* 0x0135  */
    IOP_VIM_ETHERNET_ROLE                                           , /* 0x0136  */
    IOP_VIM_ETHERNET_STATISTICS                                     , /* 0x0137  */
    IOP_VIM_ETHERNET_LOOPBACK_START                                 , /* 0x0138  */
    IOP_VIM_ETHERNET_LOOPBACK_STOP                                  , /* 0x0139  */
    IOP_VIM_PKT_SCREEN_RGB_CONTRAST                                 , /* 0x013A  */
    IOP_VIM_PKT_GET_RVC_ON_OFF                                      , /* 0x013B  */
    IOP_VIM_PKT_SET_RVC_ON_OFF_BY_CAR_GRADE                         , /* 0x013C  */
    IOP_VIM_PKT_SET_RVC_ON_OFF                                      , /* 0x013D  */
    IOP_VIM_HMI_MODE                                                , /* 0x013E  */
    IOP_VIM_IE_WIFI_CONFIG_READY                                    , /* 0x013F  */
    IOP_VIM_PKT_RTC_TIME_SYNC                                       , /* 0x0140  */
    IOP_VIM_VIDEO_SPI_ESD                                           , /* 0x0141  */
    IOP_VIM_PKT_REQUIRE_ACK                                         , /* 0x0142  */
    IOP_VIM_PKT_ACK                                                 , /* 0x0143  */
    IOP_VIM_TA_RSA_N                                                , /* 0x0144  */
    IOP_VIM_TA_RSA_D                                                , /* 0x0145  */
    IOP_VIM_TA_ESN_ENCRYPT                                          , /* 0x0146  */
    IOP_SET_NAV_MASK_ON_OFF                                         , /* 0x0147  */
    IOP_GET_NAV_MASK_STATUS                                         , /* 0x0148  */
    IOP_VIM_PKT_ACCESSORY_CMD                                       , /* 0x0149  */
    IOP_VIM_PKT_ACCESSORY_DATA                                      , /* 0x014A  */
    IOP_VIM_PKT_QRCODE_CMD                                          , /* 0x014B  */
