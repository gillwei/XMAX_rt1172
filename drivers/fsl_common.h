...
#define AT_BOARDSDRAM_SECTION_INIT(var) __attribute__((section("BoardSdram.init"))) var
#define AT_BOARDSDRAM_SECTION_ALIGN_INIT(var, alignbytes) \
    __attribute__((section("BoardSdram.init"))) var __attribute__((aligned(alignbytes)))
#define AT_BOARDSDRAM_SECTION(var) __attribute__((section("BoardSdram,\"aw\",%nobits @"))) var
#define AT_BOARDSDRAM_SECTION_ALIGN(var, alignbytes) \
