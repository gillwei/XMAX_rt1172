...
flexcan_hw_init_t const can2_hw_init_data =
{
    ...
    ------------------------------------------------------*/
    {
        ...
        { CAN0_RXF_FACT_INSP_NS_REQ_STD,RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXG_FACT_INSP2_GA_STD,   RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXH_VH_EG_SPD_STD,       RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXI_TPMS_STAT_STD,       RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXJ_MT_SYS_MOD_STD,      RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXK_GRIP_W_BTN_STAT_STD, RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXL_MT_GEAR_POS_STD,     RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXM_ODO_TRIP_VAL_STD,    RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXN_MT_SET_INFO_STD,     RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXO_ECU_SYS_MOD_STD,     RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXP_APS_ETV_STD,         RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXQ_DIAG_EGMOD_STD,      RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXR_EG_STAT_STD,         RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXS_ECU_GEAR_POS_STD,    RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXT_ECU_STAT_TCU_STD,    RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXU_ECVT_STAT_TCU_STD,   RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXV_ABS_PRESS_STD,       RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXW_ABS_STAT_STD,        RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXX_SMT_STAT_STD,        RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXY_TLCU_COM_DATA_STD,   RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXZ0_TLCU_SIG_STD,       RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
        { CAN0_RXZ1_TCU_STAT_ECU_STD,   RX_MB_DEF_MSK,    CAN_STANDARD_MSG_TYPE, CAN_DATA_MSG_TYPE },
    },
};
