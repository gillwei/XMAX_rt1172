...
#define     TX_NM_AND_LP_BK_CAN0_ID                             (0x127)
...
#define     RX_NM_AND_LP_BK_CAN0_ID                             (0x126)
...
#define     RXH_VH_EG_SPD_CAN0_ID                               (0x20A)
#define     RXI_TPMS_STAT_CAN0_ID                               (0x550)
#define     RXJ_MT_SYS_MOD_CAN0_ID                              (0x226)
#define     RXK_GRIP_W_BTN_STAT_CAN0_ID                         (0x22E)
#define     RXL_MT_GEAR_POS_CAN0_ID                             (0x236)
#define     RXM_ODO_TRIP_VAL_CAN0_ID                            (0x2A1)
#define     RXN_MT_SET_INFO_CAN0_ID                             (0x590)
#define     RXO_ECU_SYS_MOD_CAN0_ID                             (0x215)
#define     RXP_APS_ETV_CAN0_ID                                 (0x216)
#define     RXQ_DIAG_EGMOD_CAN0_ID                              (0x23A)
#define     RXR_EG_STAT_CAN0_ID                                 (0x23E)
#define     RXS_ECU_GEAR_POS_CAN0_ID                            (0x245)
#define     RXT_ECU_STAT_TCU_CAN0_ID                            (0x2AA)
#define     RXU_ECVT_STAT_TCU_CAN0_ID                           (0x2AB)
#define     RXV_ABS_PRESS_CAN0_ID                               (0x260)
#define     RXW_ABS_STAT_CAN0_ID                                (0x268)
#define     RXX_SMT_STAT_CAN0_ID                                (0x555)
#define     RXY_TLCU_COM_DATA_CAN0_ID                           (0x404)
#define     RXZ0_TLCU_SIG_CAN0_ID                               (0x2B1)
#define     RXZ1_TCU_STAT_ECU_CAN0_ID                           (0x2BA)
...
#define     IL_CAN0_RXH_VH_EG_SPD_RXFRM_LEN                     (8)
#define     IL_CAN0_RXI_TPMS_STAT_RXFRM_LEN                     (8)
#define     IL_CAN0_RXJ_MT_SYS_MOD_RXFRM_LEN                    (7)
#define     IL_CAN0_RXK_GRIP_W_BTN_STAT_RXFRM_LEN               (2)
#define     IL_CAN0_RXL_MT_GEAR_POS_RXFRM_LEN                   (1)
#define     IL_CAN0_RXM_ODO_TRIP_VAL_RXFRM_LEN                  (8)
#define     IL_CAN0_RXN_MT_SET_INFO_RXFRM_LEN                   (4)
#define     IL_CAN0_RXO_ECU_SYS_MOD_RXFRM_LEN                   (8)
#define     IL_CAN0_RXP_APS_ETV_RXFRM_LEN                       (7)
#define     IL_CAN0_RXQ_DIAG_EGMOD_RXFRM_LEN                    (3)
#define     IL_CAN0_RXR_EG_STAT_RXFRM_LEN                       (4)
#define     IL_CAN0_RXS_ECU_GEAR_POS_RXFRM_LEN                  (1)
#define     IL_CAN0_RXT_ECU_STAT_TCU_RXFRM_LEN                  (8)
#define     IL_CAN0_RXU_ECVT_STAT_TCU_RXFRM_LEN                 (4)
#define     IL_CAN0_RXV_ABS_PRESS_RXFRM_LEN                     (8)
#define     IL_CAN0_RXW_ABS_STAT_RXFRM_LEN                      (6)
#define     IL_CAN0_RXX_SMT_STAT_RXFRM_LEN                      (8)
#define     IL_CAN0_RXY_TLCU_COM_DATA_RXFRM_LEN                 (1)
#define     IL_CAN0_RXZ0_TLCU_SIG_RXFRM_LEN                     (4)
#define     IL_CAN0_RXZ1_TCU_STAT_ECU_RXFRM_LEN                 (5)
...
#define     IL_CAN0_RXF_FACT_INSP_NS_RXFRM_MIN_LEN              (8)
#define     IL_CAN0_RXG_FACT_INSP2_GA_RXFRM_MIN_LEN             (8)
#define     IL_CAN0_RXH_VH_EG_SPD_RXFRM_MIN_LEN                 (6)
#define     IL_CAN0_RXI_TPMS_STAT_RXFRM_MIN_LEN                 (8)
#define     IL_CAN0_RXJ_MT_SYS_MOD_RXFRM_MIN_LEN                (7)
#define     IL_CAN0_RXK_GRIP_W_BTN_STAT_RXFRM_MIN_LEN           (2)
#define     IL_CAN0_RXL_MT_GEAR_POS_RXFRM_MIN_LEN               (1)
#define     IL_CAN0_RXM_ODO_TRIP_VAL_RXFRM_MIN_LEN              (8)
#define     IL_CAN0_RXN_MT_SET_INFO_RXFRM_MIN_LEN               (4)
#define     IL_CAN0_RXO_ECU_SYS_MOD_RXFRM_MIN_LEN               (8)
#define     IL_CAN0_RXP_APS_ETV_RXFRM_MIN_LEN                   (7)
#define     IL_CAN0_RXQ_DIAG_EGMOD_RXFRM_MIN_LEN                (3)
#define     IL_CAN0_RXR_EG_STAT_RXFRM_MIN_LEN                   (4)
#define     IL_CAN0_RXS_ECU_GEAR_POS_RXFRM_MIN_LEN              (1)
#define     IL_CAN0_RXT_ECU_STAT_TCU_RXFRM_MIN_LEN              (8)
#define     IL_CAN0_RXU_ECVT_STAT_TCU_RXFRM_MIN_LEN             (4)
#define     IL_CAN0_RXV_ABS_PRESS_RXFRM_MIN_LEN                 (8)
#define     IL_CAN0_RXW_ABS_STAT_RXFRM_MIN_LEN                  (6)
#define     IL_CAN0_RXX_SMT_STAT_RXFRM_MIN_LEN                  (8)
#define     IL_CAN0_RXY_TLCU_COM_DATA_RXFRM_MIN_LEN             (1)
#define     IL_CAN0_RXZ0_TLCU_SIG_RXFRM_MIN_LEN                 (4)
#define     IL_CAN0_RXZ1_TCU_STAT_ECU_RXFRM_MIN_LEN             (4)
...
#define     IL_CAN0_RXH_VH_EG_SPD_RXFRM_INDEX                   DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXH_VH_EG_SPD_RXFRM_HANDLE )
#define     IL_CAN0_RXI_TPMS_STAT_RXFRM_INDEX                   DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXI_TPMS_STAT_RXFRM_HANDLE )
#define     IL_CAN0_RXJ_MT_SYS_MOD_RXFRM_INDEX                  DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXJ_MT_SYS_MOD_RXFRM_HANDLE )
#define     IL_CAN0_RXK_GRIP_W_BTN_STAT_RXFRM_INDEX             DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXK_GRIP_W_BTN_STAT_RXFRM_HANDLE )
#define     IL_CAN0_RXL_MT_GEAR_POS_RXFRM_INDEX                 DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXL_MT_GEAR_POS_RXFRM_HANDLE )
#define     IL_CAN0_RXM_ODO_TRIP_VAL_RXFRM_INDEX                DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXM_ODO_TRIP_VAL_RXFRM_HANDLE )
#define     IL_CAN0_RXN_MT_SET_INFO_RXFRM_INDEX                 DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXN_MT_SET_INFO_RXFRM_HANDLE )
#define     IL_CAN0_RXO_ECU_SYS_MOD_RXFRM_INDEX                 DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXO_ECU_SYS_MOD_RXFRM_HANDLE )
#define     IL_CAN0_RXP_APS_ETV_RXFRM_INDEX                     DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXP_APS_ETV_RXFRM_HANDLE )
#define     IL_CAN0_RXQ_DIAG_EGMOD_RXFRM_INDEX                  DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXQ_DIAG_EGMOD_RXFRM_HANDLE )
#define     IL_CAN0_RXR_EG_STAT_RXFRM_INDEX                     DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXR_EG_STAT_RXFRM_HANDLE )
#define     IL_CAN0_RXS_ECU_GEAR_POS_RXFRM_INDEX                DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXS_ECU_GEAR_POS_RXFRM_HANDLE )
#define     IL_CAN0_RXT_ECU_STAT_TCU_RXFRM_INDEX                DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXT_ECU_STAT_TCU_RXFRM_HANDLE )
#define     IL_CAN0_RXU_ECVT_STAT_TCU_RXFRM_INDEX               DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXU_ECVT_STAT_TCU_RXFRM_HANDLE )
#define     IL_CAN0_RXV_ABS_PRESS_RXFRM_INDEX                   DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXV_ABS_PRESS_RXFRM_HANDLE )
#define     IL_CAN0_RXW_ABS_STAT_RXFRM_INDEX                    DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXW_ABS_STAT_RXFRM_HANDLE )
#define     IL_CAN0_RXX_SMT_STAT_RXFRM_INDEX                    DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXX_SMT_STAT_RXFRM_HANDLE )
#define     IL_CAN0_RXY_TLCU_COM_DATA_RXFRM_INDEX               DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXY_TLCU_COM_DATA_RXFRM_HANDLE )
#define     IL_CAN0_RXZ0_TLCU_SIG_RXFRM_INDEX                   DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXZ0_TLCU_SIG_RXFRM_HANDLE )
#define     IL_CAN0_RXZ1_TCU_STAT_ECU_RXFRM_INDEX               DLL_GET_INDEX_FROM_FRAME_HANDLE( IL_CAN0_RXZ1_TCU_STAT_ECU_RXFRM_HANDLE )

#define     IL_CAN0_RX_NUM_FRAMES                               (0x002D)
...
#define     DLL_CAN0_VCTR26_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR27_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR28_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR29_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR30_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR31_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR32_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR33_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR34_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR35_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR36_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR37_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR38_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR39_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR40_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR41_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR42_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR43_NUM_IDS                             (1)
#define     DLL_CAN0_VCTR44_NUM_IDS                             (1)

#define     DLL_CAN0_NUM_FILT_VCTRS                             (45)
