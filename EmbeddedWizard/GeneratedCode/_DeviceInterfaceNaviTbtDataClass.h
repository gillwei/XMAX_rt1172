...
#ifndef _DeviceInterfaceNaviTbtDataClass_H
#define _DeviceInterfaceNaviTbtDataClass_H
...
/* Deklaration of class : 'DeviceInterface::NaviTbtDataClass' */
EW_DEFINE_FIELDS( DeviceInterfaceNaviTbtDataClass, XObject )
  EW_VARIABLE( DistUnit,        XString )
  EW_VARIABLE( TbtDescription,  XString )
  EW_VARIABLE( IconIdx,         XInt32 )
  EW_VARIABLE( ListIdx,         XInt32 )
...
EW_DEFINE_METHODS( DeviceInterfaceNaviTbtDataClass, XObject )
EW_END_OF_METHODS( DeviceInterfaceNaviTbtDataClass )

#ifdef __cplusplus
  }
#endif

#endif /* _DeviceInterfaceNaviTbtDataClass_H */
