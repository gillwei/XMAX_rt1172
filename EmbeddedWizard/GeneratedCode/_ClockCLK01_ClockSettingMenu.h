...
#ifndef _ClockCLK01_ClockSettingMenu_H
#define _ClockCLK01_ClockSettingMenu_H
...
/* Forward declaration of the class Clock::CLK01_ClockSettingMenu */
#ifndef _ClockCLK01_ClockSettingMenu_
  EW_DECLARE_CLASS( ClockCLK01_ClockSettingMenu )
#define _ClockCLK01_ClockSettingMenu_
#endif
...
/* Deklaration of class : 'Clock::CLK01_ClockSettingMenu' */
EW_DEFINE_FIELDS( ClockCLK01_ClockSettingMenu, MenuBaseMenuView )
  EW_VARIABLE( ClockManualAdjComponent, ClockCLK02_ClockManualAdjustment )
  EW_ARRAY   ( ItemTitleArray,  XString, [2])
  EW_ARRAY   ( ItemClassArray,  XClass, [2])
EW_END_OF_FIELDS( ClockCLK01_ClockSettingMenu )

/* Virtual Method Table (VMT) for the class : 'Clock::CLK01_ClockSettingMenu' */
EW_DEFINE_METHODS( ClockCLK01_ClockSettingMenu, MenuBaseMenuView )
  ...
  EW_METHOD( LoadItemClass,     XClass )( ClockCLK01_ClockSettingMenu _this, XInt32 
    aItemNo )
  EW_METHOD( LoadItemTitle,     XString )( ClockCLK01_ClockSettingMenu _this, XInt32 
    aItemNo )
  EW_METHOD( OnItemActivate,    void )( ClockCLK01_ClockSettingMenu _this, XInt32 
    aItemNo, MenuItemBase aMenuItem )
  EW_METHOD( LoadItemChecked,   XBool )( ClockCLK01_ClockSettingMenu _this, XInt32 
    aItemNo )
  EW_METHOD( LoadItemEnabled,   XBool )( ClockCLK01_ClockSettingMenu _this, XInt32 
    aItemNo )
...
#endif /* _ClockCLK01_ClockSettingMenu_H */
