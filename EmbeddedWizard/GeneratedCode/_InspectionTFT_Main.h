...
#ifndef _InspectionTFT_Main_H
#define _InspectionTFT_Main_H
...
/* Forward declaration of the class Inspection::TFT_Main */
#ifndef _InspectionTFT_Main_
  EW_DECLARE_CLASS( InspectionTFT_Main )
#define _InspectionTFT_Main_
#endif


/* Deklaration of class : 'Inspection::TFT_Main' */
EW_DEFINE_FIELDS( InspectionTFT_Main, ComponentsBaseMainBG )
  EW_OBJECT  ( FullScreen,      ViewsRectangle )
  EW_OBJECT  ( CrossTalk,       InspectionTFT10_CrossTalk )
  EW_OBJECT  ( Flicker,         InspectionTFT09_Flicker )
  EW_OBJECT  ( ColorGradient,   InspectionTFT01_ColorGradient )
  EW_PROPERTY( Pattern,         XEnum )
EW_END_OF_FIELDS( InspectionTFT_Main )

/* Virtual Method Table (VMT) for the class : 'Inspection::TFT_Main' */
EW_DEFINE_METHODS( InspectionTFT_Main, ComponentsBaseMainBG )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( OnShortDownKeyActivated, void )( InspectionTFT_Main _this )
  EW_METHOD( OnShortUpKeyActivated, void )( InspectionTFT_Main _this )
...
EW_END_OF_METHODS( InspectionTFT_Main )
