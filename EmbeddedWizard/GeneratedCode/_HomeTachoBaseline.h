...
#ifndef _HomeTachoBaseline_H
#define _HomeTachoBaseline_H
...
/* Forward declaration of the class Home::TachoBaseline */
#ifndef _HomeTachoBaseline_
  EW_DECLARE_CLASS( HomeTachoBaseline )
#define _HomeTachoBaseline_
#endif


/* Deklaration of class : 'Home::TachoBaseline' */
EW_DEFINE_FIELDS( HomeTachoBaseline, CoreGroup )
  EW_PROPERTY( RedZoneBeginRPM, XInt32 )
  EW_PROPERTY( FullScaleType,   XEnum )
EW_END_OF_FIELDS( HomeTachoBaseline )

/* Virtual Method Table (VMT) for the class : 'Home::TachoBaseline' */
EW_DEFINE_METHODS( HomeTachoBaseline, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( HomeTachoBaseline _this, XPoint aSize )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( HomeTachoBaseline )
