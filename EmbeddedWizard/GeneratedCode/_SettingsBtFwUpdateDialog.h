...
#ifndef _SettingsBtFwUpdateDialog_H
#define _SettingsBtFwUpdateDialog_H
...
/* Forward declaration of the class Settings::BtFwUpdateDialog */
#ifndef _SettingsBtFwUpdateDialog_
  EW_DECLARE_CLASS( SettingsBtFwUpdateDialog )
#define _SettingsBtFwUpdateDialog_
#endif
...
EW_DEFINE_METHODS( SettingsBtFwUpdateDialog, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( SettingsBtFwUpdateDialog )
...
#endif /* _SettingsBtFwUpdateDialog_H */
