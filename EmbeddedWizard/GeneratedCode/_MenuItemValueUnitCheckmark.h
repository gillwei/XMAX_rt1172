...
#ifndef _MenuItemValueUnitCheckmark_H
#define _MenuItemValueUnitCheckmark_H
...
/* Forward declaration of the class Menu::ItemValueUnitCheckmark */
#ifndef _MenuItemValueUnitCheckmark_
  EW_DECLARE_CLASS( MenuItemValueUnitCheckmark )
#define _MenuItemValueUnitCheckmark_
#endif


/* Deklaration of class : 'Menu::ItemValueUnitCheckmark' */
EW_DEFINE_FIELDS( MenuItemValueUnitCheckmark, MenuItemCheckMark )
  EW_OBJECT  ( ValueText,       ViewsText )
  EW_OBJECT  ( UnitText,        ViewsText )
  EW_PROPERTY( Value,           XString )
  EW_PROPERTY( Unit,            XString )
EW_END_OF_FIELDS( MenuItemValueUnitCheckmark )

/* Virtual Method Table (VMT) for the class : 'Menu::ItemValueUnitCheckmark' */
EW_DEFINE_METHODS( MenuItemValueUnitCheckmark, MenuItemCheckMark )
...
#endif /* _MenuItemValueUnitCheckmark_H */
