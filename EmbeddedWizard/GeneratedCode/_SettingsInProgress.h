...
#ifndef _SettingsInProgress_H
#define _SettingsInProgress_H
...
/* Deklaration of class : 'Settings::InProgress' */
EW_DEFINE_FIELDS( SettingsInProgress, MenuBaseMenuView )
  EW_OBJECT  ( Text,            ViewsText )
EW_END_OF_FIELDS( SettingsInProgress )

/* Virtual Method Table (VMT) for the class : 'Settings::InProgress' */
EW_DEFINE_METHODS( SettingsInProgress, MenuBaseMenuView )
...
EW_END_OF_METHODS( SettingsInProgress )

#ifdef __cplusplus
  }
#endif

#endif /* _SettingsInProgress_H */
