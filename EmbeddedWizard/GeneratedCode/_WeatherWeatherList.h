...
#ifndef _WeatherWeatherList_H
#define _WeatherWeatherList_H
...
/* Forward declaration of the class Weather::WeatherList */
#ifndef _WeatherWeatherList_
  EW_DECLARE_CLASS( WeatherWeatherList )
#define _WeatherWeatherList_
#endif


/* Deklaration of class : 'Weather::WeatherList' */
EW_DEFINE_FIELDS( WeatherWeatherList, ComponentsBaseComponent )
...
EW_END_OF_FIELDS( WeatherWeatherList )

/* Virtual Method Table (VMT) for the class : 'Weather::WeatherList' */
EW_DEFINE_METHODS( WeatherWeatherList, ComponentsBaseComponent )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( OnShortDownKeyActivated, void )( WeatherWeatherList _this )
  EW_METHOD( OnShortUpKeyActivated, void )( WeatherWeatherList _this )
...
EW_END_OF_METHODS( WeatherWeatherList )
