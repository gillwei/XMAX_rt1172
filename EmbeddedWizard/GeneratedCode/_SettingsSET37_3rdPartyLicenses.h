...
#ifndef _SettingsSET37_3rdPartyLicenses_H
#define _SettingsSET37_3rdPartyLicenses_H
...
/* Forward declaration of the class Settings::SET37_3rdPartyLicenses */
#ifndef _SettingsSET37_3rdPartyLicenses_
  EW_DECLARE_CLASS( SettingsSET37_3rdPartyLicenses )
#define _SettingsSET37_3rdPartyLicenses_
#endif


/* Deklaration of class : 'Settings::SET37_3rdPartyLicenses' */
EW_DEFINE_FIELDS( SettingsSET37_3rdPartyLicenses, ComponentsBaseMainBG )
  EW_OBJECT  ( Scrollbar,       MenuScrollbar )
  EW_OBJECT  ( ThirdPartyLicenseText, SettingsLicenseDetail )
EW_END_OF_FIELDS( SettingsSET37_3rdPartyLicenses )

/* Virtual Method Table (VMT) for the class : 'Settings::SET37_3rdPartyLicenses' */
EW_DEFINE_METHODS( SettingsSET37_3rdPartyLicenses, ComponentsBaseMainBG )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( OnShortDownKeyActivated, void )( SettingsSET37_3rdPartyLicenses _this )
  EW_METHOD( OnShortUpKeyActivated, void )( SettingsSET37_3rdPartyLicenses _this )
  EW_METHOD( OnShortEnterKeyActivated, void )( SettingsSET37_3rdPartyLicenses _this )
...
EW_END_OF_METHODS( SettingsSET37_3rdPartyLicenses )
...
#endif /* _SettingsSET37_3rdPartyLicenses_H */
