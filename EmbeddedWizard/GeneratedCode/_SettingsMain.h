...
#ifndef _SettingsMain_H
#define _SettingsMain_H
...
/* Forward declaration of the class Settings::Main */
#ifndef _SettingsMain_
  EW_DECLARE_CLASS( SettingsMain )
#define _SettingsMain_
#endif


/* Deklaration of class : 'Settings::Main' */
EW_DEFINE_FIELDS( SettingsMain, MenuBaseMenuView )
  EW_OBJECT  ( Menu,            MenuVerticalMenu )
  EW_ARRAY   ( ItemTitleArray,  XString, [2])
EW_END_OF_FIELDS( SettingsMain )

/* Virtual Method Table (VMT) for the class : 'Settings::Main' */
EW_DEFINE_METHODS( SettingsMain, MenuBaseMenuView )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( OnLongKeyPressed,  void )( SettingsMain _this, XObject sender )
  EW_METHOD( OnShortDownKeyActivated, void )( ComponentsBaseComponent _this )
  EW_METHOD( OnShortUpKeyActivated, void )( ComponentsBaseComponent _this )
  EW_METHOD( OnShortEnterKeyActivated, void )( ComponentsBaseComponent _this )
  EW_METHOD( OnShortHomeKeyActivated, void )( ComponentsBaseComponent _this )
  EW_METHOD( LoadItemClass,     XClass )( SettingsMain _this, XInt32 aItemNo )
  EW_METHOD( LoadItemTitle,     XString )( SettingsMain _this, XInt32 aItemNo )
  EW_METHOD( OnItemActivate,    void )( SettingsMain _this, XInt32 aItemNo, MenuItemBase 
    aMenuItem )
