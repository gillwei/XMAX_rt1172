...
#ifndef _SettingsLicenseDetail_H
#define _SettingsLicenseDetail_H
...
/* Forward declaration of the class Settings::LicenseDetail */
#ifndef _SettingsLicenseDetail_
  EW_DECLARE_CLASS( SettingsLicenseDetail )
#define _SettingsLicenseDetail_
#endif
...
EW_DEFINE_FIELDS( SettingsLicenseDetail, CoreGroup )
  ...
  EW_VARIABLE( LicenseInitBounds, XRect )
EW_END_OF_FIELDS( SettingsLicenseDetail )

/* Virtual Method Table (VMT) for the class : 'Settings::LicenseDetail' */
EW_DEFINE_METHODS( SettingsLicenseDetail, CoreGroup )
...
#endif /* _SettingsLicenseDetail_H */
