...
#ifndef _HomeItemVehicleInfo_H
#define _HomeItemVehicleInfo_H
...
/* Forward declaration of the class Home::ItemVehicleInfo */
#ifndef _HomeItemVehicleInfo_
  EW_DECLARE_CLASS( HomeItemVehicleInfo )
#define _HomeItemVehicleInfo_
#endif


/* Deklaration of class : 'Home::ItemVehicleInfo' */
...
EW_DEFINE_METHODS( HomeItemVehicleInfo, ComponentsBaseComponent )
