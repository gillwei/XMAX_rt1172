...
#ifndef _MenuItemCheckbox_H
#define _MenuItemCheckbox_H
...
/* Forward declaration of the class Menu::ItemCheckbox */
#ifndef _MenuItemCheckbox_
  EW_DECLARE_CLASS( MenuItemCheckbox )
#define _MenuItemCheckbox_
#endif
...
EW_DEFINE_METHODS( MenuItemCheckbox, MenuItemBase )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( MenuItemCheckbox _this, XPoint aSize )
