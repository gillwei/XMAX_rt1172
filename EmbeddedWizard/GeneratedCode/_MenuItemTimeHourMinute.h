...
#ifndef _MenuItemTimeHourMinute_H
#define _MenuItemTimeHourMinute_H
...
/* Forward declaration of the class Menu::ItemTimeHourMinute */
#ifndef _MenuItemTimeHourMinute_
  EW_DECLARE_CLASS( MenuItemTimeHourMinute )
#define _MenuItemTimeHourMinute_
#endif


/* Deklaration of class : 'Menu::ItemTimeHourMinute' */
EW_DEFINE_FIELDS( MenuItemTimeHourMinute, MenuItemBase )
  EW_OBJECT  ( HourValueText,   ViewsText )
  EW_OBJECT  ( MinuteValueText, ViewsText )
  EW_OBJECT  ( HourText,        ViewsText )
  EW_OBJECT  ( MinuteText,      ViewsText )
  EW_PROPERTY( Hour,            XString )
  EW_PROPERTY( Minute,          XString )
EW_END_OF_FIELDS( MenuItemTimeHourMinute )

/* Virtual Method Table (VMT) for the class : 'Menu::ItemTimeHourMinute' */
EW_DEFINE_METHODS( MenuItemTimeHourMinute, MenuItemBase )
...
EW_END_OF_METHODS( MenuItemTimeHourMinute )
...
#endif /* _MenuItemTimeHourMinute_H */
