...
#ifndef _MenuItemNotification_H
#define _MenuItemNotification_H
...
/* Forward declaration of the class Menu::ItemNotification */
#ifndef _MenuItemNotification_
  EW_DECLARE_CLASS( MenuItemNotification )
#define _MenuItemNotification_
#endif
...
EW_END_OF_FIELDS( MenuItemNotification )

/* Virtual Method Table (VMT) for the class : 'Menu::ItemNotification' */
EW_DEFINE_METHODS( MenuItemNotification, MenuItemBase )
...
EW_END_OF_METHODS( MenuItemNotification )
