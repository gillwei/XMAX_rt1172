...
#ifndef _TelephoneImageButton_H
#define _TelephoneImageButton_H
...
/* Forward declaration of the class Telephone::ImageButton */
#ifndef _TelephoneImageButton_
  EW_DECLARE_CLASS( TelephoneImageButton )
#define _TelephoneImageButton_
#endif


/* Deklaration of class : 'Telephone::ImageButton' */
EW_DEFINE_FIELDS( TelephoneImageButton, CoreGroup )
  EW_PROPERTY( ForegroundBmp,   ResourcesBitmap )
  EW_OBJECT  ( BackgroundImage, ViewsImage )
  EW_OBJECT  ( ForegroundImage, ViewsImage )
  EW_OBJECT  ( HighlightTimer,  CoreTimer )
  EW_PROPERTY( ForegroundFrameNumber, XInt32 )
EW_END_OF_FIELDS( TelephoneImageButton )

/* Virtual Method Table (VMT) for the class : 'Telephone::ImageButton' */
EW_DEFINE_METHODS( TelephoneImageButton, CoreGroup )
