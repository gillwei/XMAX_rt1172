...
#ifndef _ComponentsPushButton_H
#define _ComponentsPushButton_H
...
/* Forward declaration of the class Components::PushButton */
#ifndef _ComponentsPushButton_
  EW_DECLARE_CLASS( ComponentsPushButton )
#define _ComponentsPushButton_
#endif
...
/* Deklaration of class : 'Components::PushButton' */
EW_DEFINE_FIELDS( ComponentsPushButton, WidgetSetPushButton )
  EW_PROPERTY( PassKeyHold,     XSlot )
EW_END_OF_FIELDS( ComponentsPushButton )

/* Virtual Method Table (VMT) for the class : 'Components::PushButton' */
EW_DEFINE_METHODS( ComponentsPushButton, WidgetSetPushButton )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsPushButton )
