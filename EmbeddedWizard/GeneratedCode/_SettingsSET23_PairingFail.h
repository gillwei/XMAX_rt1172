...
#ifndef _SettingsSET23_PairingFail_H
#define _SettingsSET23_PairingFail_H
...
/* Forward declaration of the class Settings::SET23_PairingFail */
#ifndef _SettingsSET23_PairingFail_
  EW_DECLARE_CLASS( SettingsSET23_PairingFail )
#define _SettingsSET23_PairingFail_
#endif


/* Deklaration of class : 'Settings::SET23_PairingFail' */
EW_DEFINE_FIELDS( SettingsSET23_PairingFail, SettingsTimeoutDialog )
EW_END_OF_FIELDS( SettingsSET23_PairingFail )

/* Virtual Method Table (VMT) for the class : 'Settings::SET23_PairingFail' */
EW_DEFINE_METHODS( SettingsSET23_PairingFail, SettingsTimeoutDialog )
  ...
  EW_METHOD( OnTimeoutSlot,     void )( SettingsSET23_PairingFail _this, XObject 
    sender )
EW_END_OF_METHODS( SettingsSET23_PairingFail )
...
#endif /* _SettingsSET23_PairingFail_H */
