...
#ifndef _SettingsAllResetCompleted_H
#define _SettingsAllResetCompleted_H
...
/* Forward declaration of the class Settings::AllResetCompleted */
#ifndef _SettingsAllResetCompleted_
  EW_DECLARE_CLASS( SettingsAllResetCompleted )
#define _SettingsAllResetCompleted_
#endif


/* Deklaration of class : 'Settings::AllResetCompleted' */
EW_DEFINE_FIELDS( SettingsAllResetCompleted, MenuBaseMenuView )
  EW_OBJECT  ( Text,            ViewsText )
EW_END_OF_FIELDS( SettingsAllResetCompleted )

/* Virtual Method Table (VMT) for the class : 'Settings::AllResetCompleted' */
EW_DEFINE_METHODS( SettingsAllResetCompleted, MenuBaseMenuView )
...
#endif /* _SettingsAllResetCompleted_H */
