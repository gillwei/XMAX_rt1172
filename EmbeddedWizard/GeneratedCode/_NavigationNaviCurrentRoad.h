...
#ifndef _NavigationNaviCurrentRoad_H
#define _NavigationNaviCurrentRoad_H
...
/* Forward declaration of the class Navigation::NaviCurrentRoad */
#ifndef _NavigationNaviCurrentRoad_
  EW_DECLARE_CLASS( NavigationNaviCurrentRoad )
#define _NavigationNaviCurrentRoad_
#endif
...
EW_DEFINE_METHODS( NavigationNaviCurrentRoad, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( NavigationNaviCurrentRoad )
...
#endif /* _NavigationNaviCurrentRoad_H */
