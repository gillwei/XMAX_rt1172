...
EW_DEFINE_FIELDS( WeatherWeatherWeekViewUI, CoreGroup )
  ...
  EW_OBJECT  ( DayOneText,      ComponentsBaseText )
  EW_OBJECT  ( DayOneChanceOfRain, ComponentsBaseText )
  EW_OBJECT  ( DayOneMinTemp,   ComponentsBaseText )
  ...
  EW_OBJECT  ( DayTwoText,      ComponentsBaseText )
  EW_OBJECT  ( DayTwoChanceOfRain, ComponentsBaseText )
  EW_OBJECT  ( DayTwoRainPerIcon, ViewsImage )
  EW_OBJECT  ( DayTwoMinTemp,   ComponentsBaseText )
  EW_OBJECT  ( DayThreeWeather, ViewsImage )
  EW_OBJECT  ( DayThreeText,    ComponentsBaseText )
  EW_OBJECT  ( DayThreeChanceOfRain, ComponentsBaseText )
  EW_OBJECT  ( DayThreeRainPerIcon, ViewsImage )
  EW_OBJECT  ( DayThreeMinTemp, ComponentsBaseText )
  ...
  EW_OBJECT  ( DayFourText,     ComponentsBaseText )
  EW_OBJECT  ( DayFiveText,     ComponentsBaseText )
  EW_OBJECT  ( DaySixText,      ComponentsBaseText )
  EW_OBJECT  ( DivideLineDownLeft, ViewsLine )
  EW_OBJECT  ( DivideLineDownRight, ViewsLine )
  EW_OBJECT  ( DayFourChanceOfRain, ComponentsBaseText )
  EW_OBJECT  ( DayFiveChanceOfRain, ComponentsBaseText )
  EW_OBJECT  ( DaySixChanceOfRain, ComponentsBaseText )
  EW_OBJECT  ( DayFourRainPerIcon, ViewsImage )
  EW_OBJECT  ( DayFiveRainPerIcon, ViewsImage )
  EW_OBJECT  ( DaySixRainPerIcon, ViewsImage )
  EW_OBJECT  ( DayFourMinTemp,  ComponentsBaseText )
  EW_OBJECT  ( DayFiveMinTemp,  ComponentsBaseText )
  EW_OBJECT  ( DaySixMinTemp,   ComponentsBaseText )
  ...
  EW_OBJECT  ( DayOneMaxTemp,   ComponentsBaseText )
  EW_OBJECT  ( DayTwoTempSlash, ViewsText )
  EW_OBJECT  ( DayTwoMaxTemp,   ComponentsBaseText )
  EW_OBJECT  ( DayThreeTempSlash, ViewsText )
  EW_OBJECT  ( DayThreeMaxTemp, ComponentsBaseText )
  EW_OBJECT  ( DayFourTempSlash, ViewsText )
  EW_OBJECT  ( DayFourMaxTemp,  ComponentsBaseText )
  EW_OBJECT  ( DayFiveTempSlash, ViewsText )
  EW_OBJECT  ( DayFiveMaxTemp,  ComponentsBaseText )
  EW_OBJECT  ( DaySixTempSlash, ViewsText )
  EW_OBJECT  ( DaySixMaxTemp,   ComponentsBaseText )
