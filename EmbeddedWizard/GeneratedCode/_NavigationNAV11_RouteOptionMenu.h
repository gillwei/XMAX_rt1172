...
#ifndef _NavigationNAV11_RouteOptionMenu_H
#define _NavigationNAV11_RouteOptionMenu_H
...
/* Forward declaration of the class Navigation::NAV11_RouteOptionMenu */
#ifndef _NavigationNAV11_RouteOptionMenu_
  EW_DECLARE_CLASS( NavigationNAV11_RouteOptionMenu )
#define _NavigationNAV11_RouteOptionMenu_
#endif


/* Deklaration of class : 'Navigation::NAV11_RouteOptionMenu' */
EW_DEFINE_FIELDS( NavigationNAV11_RouteOptionMenu, MenuBaseMenuView )
  EW_ARRAY   ( NaviRouteOptions, XEnum, [3])
EW_END_OF_FIELDS( NavigationNAV11_RouteOptionMenu )

/* Virtual Method Table (VMT) for the class : 'Navigation::NAV11_RouteOptionMenu' */
EW_DEFINE_METHODS( NavigationNAV11_RouteOptionMenu, MenuBaseMenuView )
  ...
  EW_METHOD( LoadItemClass,     XClass )( NavigationNAV11_RouteOptionMenu _this, 
    XInt32 aItemNo )
  EW_METHOD( LoadItemTitle,     XString )( NavigationNAV11_RouteOptionMenu _this, 
    XInt32 aItemNo )
  EW_METHOD( OnItemActivate,    void )( NavigationNAV11_RouteOptionMenu _this, XInt32 
...
#endif /* _NavigationNAV11_RouteOptionMenu_H */
