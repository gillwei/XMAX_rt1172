...
#ifndef _MenuItemValueUnit_H
#define _MenuItemValueUnit_H
...
/* Forward declaration of the class Menu::ItemValueUnit */
#ifndef _MenuItemValueUnit_
  EW_DECLARE_CLASS( MenuItemValueUnit )
#define _MenuItemValueUnit_
#endif


/* Deklaration of class : 'Menu::ItemValueUnit' */
EW_DEFINE_FIELDS( MenuItemValueUnit, MenuItemBase )
  EW_OBJECT  ( ValueText,       ViewsText )
  EW_OBJECT  ( UnitText,        ViewsText )
  EW_PROPERTY( Value,           XString )
  EW_PROPERTY( Unit,            XString )
EW_END_OF_FIELDS( MenuItemValueUnit )

/* Virtual Method Table (VMT) for the class : 'Menu::ItemValueUnit' */
EW_DEFINE_METHODS( MenuItemValueUnit, MenuItemBase )
