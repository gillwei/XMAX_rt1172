...
EW_DEFINE_FIELDS( HomeHOM11_TachoVisualizer, ComponentsBaseMainBG )
...
EW_DEFINE_METHODS( HomeHOM11_TachoVisualizer, ComponentsBaseMainBG )
  ...
  EW_METHOD( OnShortHomeKeyActivated, void )( HomeHOM11_TachoVisualizer _this )
