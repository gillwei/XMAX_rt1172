...
#ifndef _SettingsTimeoutDialog_H
#define _SettingsTimeoutDialog_H
...
/* Forward declaration of the class Settings::TimeoutDialog */
#ifndef _SettingsTimeoutDialog_
  EW_DECLARE_CLASS( SettingsTimeoutDialog )
#define _SettingsTimeoutDialog_
#endif


/* Deklaration of class : 'Settings::TimeoutDialog' */
EW_DEFINE_FIELDS( SettingsTimeoutDialog, ComponentsBaseMainBG )
  EW_PROPERTY( OnTimeout,       XSlot )
  EW_OBJECT  ( MessageText,     ViewsText )
  EW_OBJECT  ( TimeoutTimer,    CoreTimer )
  EW_PROPERTY( Message,         XString )
  EW_PROPERTY( DismissAfterTimeout, XBool )
EW_END_OF_FIELDS( SettingsTimeoutDialog )

/* Virtual Method Table (VMT) for the class : 'Settings::TimeoutDialog' */
EW_DEFINE_METHODS( SettingsTimeoutDialog, ComponentsBaseMainBG )
  ...
  EW_METHOD( OnTimeoutSlot,     void )( SettingsTimeoutDialog _this, XObject sender )
EW_END_OF_METHODS( SettingsTimeoutDialog )
...
#endif /* _SettingsTimeoutDialog_H */
