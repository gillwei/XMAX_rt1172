...
#ifndef _PopPOP04_Reset_H
#define _PopPOP04_Reset_H
...
/* Forward declaration of the class Pop::POP04_Reset */
#ifndef _PopPOP04_Reset_
  EW_DECLARE_CLASS( PopPOP04_Reset )
#define _PopPOP04_Reset_
#endif
...
EW_END_OF_FIELDS( PopPOP04_Reset )

/* Virtual Method Table (VMT) for the class : 'Pop::POP04_Reset' */
EW_DEFINE_METHODS( PopPOP04_Reset, ComponentsBaseMainBG )
