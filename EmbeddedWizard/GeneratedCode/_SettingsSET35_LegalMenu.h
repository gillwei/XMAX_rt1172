...
#ifndef _SettingsSET35_LegalMenu_H
#define _SettingsSET35_LegalMenu_H
...
/* Forward declaration of the class Settings::SET35_LegalMenu */
#ifndef _SettingsSET35_LegalMenu_
  EW_DECLARE_CLASS( SettingsSET35_LegalMenu )
#define _SettingsSET35_LegalMenu_
#endif


/* Deklaration of class : 'Settings::SET35_LegalMenu' */
EW_DEFINE_FIELDS( SettingsSET35_LegalMenu, MenuBaseMenuView )
EW_END_OF_FIELDS( SettingsSET35_LegalMenu )

/* Virtual Method Table (VMT) for the class : 'Settings::SET35_LegalMenu' */
EW_DEFINE_METHODS( SettingsSET35_LegalMenu, MenuBaseMenuView )
  ...
  EW_METHOD( LoadItemClass,     XClass )( SettingsSET35_LegalMenu _this, XInt32 
    aItemNo )
  EW_METHOD( LoadItemTitle,     XString )( SettingsSET35_LegalMenu _this, XInt32 
    aItemNo )
  EW_METHOD( OnItemActivate,    void )( SettingsSET35_LegalMenu _this, XInt32 aItemNo, 
...
#endif /* _SettingsSET35_LegalMenu_H */
