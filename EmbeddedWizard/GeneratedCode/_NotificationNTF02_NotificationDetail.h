...
#ifndef _NotificationNTF02_NotificationDetail_H
#define _NotificationNTF02_NotificationDetail_H
...
/* Forward declaration of the class Notification::NTF02_NotificationDetail */
#ifndef _NotificationNTF02_NotificationDetail_
  EW_DECLARE_CLASS( NotificationNTF02_NotificationDetail )
#define _NotificationNTF02_NotificationDetail_
#endif


/* Deklaration of class : 'Notification::NTF02_NotificationDetail' */
EW_DEFINE_FIELDS( NotificationNTF02_NotificationDetail, ComponentsBaseMainBG )
  EW_PROPERTY( NotificationData, DeviceInterfaceNotificationContext )
  EW_PROPERTY( OnDismiss,       XSlot )
  EW_OBJECT  ( GrayBG,          ViewsRectangle )
  EW_OBJECT  ( Scrollbar,       MenuScrollbar )
  EW_OBJECT  ( NotificationText, NotificationNotificationDetailText )
  EW_OBJECT  ( Divider,         ViewsImage )
EW_END_OF_FIELDS( NotificationNTF02_NotificationDetail )

/* Virtual Method Table (VMT) for the class : 'Notification::NTF02_NotificationDetail' */
EW_DEFINE_METHODS( NotificationNTF02_NotificationDetail, ComponentsBaseMainBG )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( OnShortDownKeyActivated, void )( NotificationNTF02_NotificationDetail _this )
  EW_METHOD( OnShortUpKeyActivated, void )( NotificationNTF02_NotificationDetail _this )
  EW_METHOD( OnShortEnterKeyActivated, void )( NotificationNTF02_NotificationDetail _this )
  EW_METHOD( OnShortHomeKeyActivated, void )( NotificationNTF02_NotificationDetail _this )
...
EW_END_OF_METHODS( NotificationNTF02_NotificationDetail )
...
#endif /* _NotificationNTF02_NotificationDetail_H */
