...
#ifndef _HomeTachoScale_H
#define _HomeTachoScale_H
...
/* Forward declaration of the class Home::TachoScale */
#ifndef _HomeTachoScale_
  EW_DECLARE_CLASS( HomeTachoScale )
#define _HomeTachoScale_
#endif


/* Deklaration of class : 'Home::TachoScale' */
EW_DEFINE_FIELDS( HomeTachoScale, CoreGroup )
  EW_ARRAY   ( HighlightImages, ViewsImage, [21])
  EW_OBJECT  ( Background,      ViewsImage )
  EW_PROPERTY( RedZoneBeginRPM, XInt32 )
  EW_PROPERTY( CurrentEngineSpeed, XUInt32 )
  EW_PROPERTY( FullScaleType,   XEnum )
EW_END_OF_FIELDS( HomeTachoScale )

/* Virtual Method Table (VMT) for the class : 'Home::TachoScale' */
EW_DEFINE_METHODS( HomeTachoScale, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( HomeTachoScale _this, XPoint aSize )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( HomeTachoScale )
