...
#ifndef _MenuScrollbar_H
#define _MenuScrollbar_H
...
/* Forward declaration of the class Menu::Scrollbar */
#ifndef _MenuScrollbar_
  EW_DECLARE_CLASS( MenuScrollbar )
#define _MenuScrollbar_
#endif
...
EW_DEFINE_FIELDS( MenuScrollbar, CoreGroup )
  ...
  EW_VARIABLE( PageNum,         XInt32 )
EW_END_OF_FIELDS( MenuScrollbar )

/* Virtual Method Table (VMT) for the class : 'Menu::Scrollbar' */
EW_DEFINE_METHODS( MenuScrollbar, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateViewState,   void )( MenuScrollbar _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( MenuScrollbar )
