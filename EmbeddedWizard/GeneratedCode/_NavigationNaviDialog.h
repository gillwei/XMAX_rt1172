...
#ifndef _NavigationNaviDialog_H
#define _NavigationNaviDialog_H
...
/* Forward declaration of the class Navigation::NaviDialog */
#ifndef _NavigationNaviDialog_
  EW_DECLARE_CLASS( NavigationNaviDialog )
#define _NavigationNaviDialog_
#endif


/* Deklaration of class : 'Navigation::NaviDialog' */
EW_DEFINE_FIELDS( NavigationNaviDialog, CoreGroup )
  ...
  EW_PROPERTY( DialogType,      XEnum )
EW_END_OF_FIELDS( NavigationNaviDialog )

/* Virtual Method Table (VMT) for the class : 'Navigation::NaviDialog' */
EW_DEFINE_METHODS( NavigationNaviDialog, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( NavigationNaviDialog )
