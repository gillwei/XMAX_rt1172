...
void navi_add_dialog( const uint8_t dialog_id, const navilite_dialog_type dialog_type, const char* message, const uint8_t message_size, const uint8_t timeout, const uint8_t default_choice );
