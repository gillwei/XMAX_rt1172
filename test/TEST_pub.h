...
#define UNIT_TEST_ENABLE        ( UNIT_TEST_INSPECTION | UNIT_TEST_PRODUCTION | UNIT_TEST_BURNIN | UNIT_TEST_JPEG | UNIT_TEST_ADC | UNIT_TEST_NAVI | UNIT_TEST_EEPROM | UNIT_TEST_VI | UNIT_TEST_NOTIFICATION )
